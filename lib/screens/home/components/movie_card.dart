...
class MovieCard extends StatelessWidget {
  ...
  Widget build (BuildContext context){
    return Padding(
      ...
      child: InkWell(
        onTap: () => Navigator.push(context,MaterialPageRoute(builder: (context) => DetailsScreen(movie: movie, key: key!,
        ),
        ...
        child: Column(
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[SvgPicture.asset("assets/icons/star_fill.svg",
                height: 20,
              ),
